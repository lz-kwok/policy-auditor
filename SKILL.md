...
2. **行业规范规则包 (Industries)**:
   - **生猪养殖与生物安全类**：文本包含“生猪、猪场、猪只、母猪、育肥、饲料、兽药、洗消、疫病、无害化、生物安全”等 -> **加载** `[swine_farming.md](file:///c:/Users/GXY/.trae-cn/skills/policy-auditor/references/industries/swine_farming.md)`
